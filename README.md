...
This is a simple user/bank account management application built using Spring Boot and Spring Data JPA. It allows admin to create/manage user accounts, bank accounts, and perform basic operations such as depositing and withdrawing funds.
